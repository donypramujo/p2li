...
@section('nav',action('ReportController@filterScoreDetail'))
@section('content')
<ul class="breadcrumb no-border no-radius b-b b-light pull-in">
	<li><a href="{{action('BackendController@index')}}"></i>{{trans('app.home')}}</a></li>
	<li class="active">{{trans('app.report.score_detail')}}</li>
</ul>
...
<section class="panel panel-default">
	<header class="panel-heading font-bold">{{trans('app.report.score_detail')}}</header>
	<div class="panel-body">
		<form action="{{action('ReportController@printScoreDetail')}}" class="form-horizontal" method="get" autocomplete="off" target="_blank" >
