...
@section('nav',action('ReportController@filterTeam'))
@section('content')
<ul class="breadcrumb no-border no-radius b-b b-light pull-in">
	<li><a href="{{action('BackendController@index')}}"></i>{{trans('app.home')}}</a></li>
	<li class="active">{{trans('app.report.team')}}</li>
</ul>
...
<section class="panel panel-default">
	<header class="panel-heading font-bold">{{trans('app.report.team')}}</header>
	<div class="panel-body">
		<form action="{{action('ReportController@printTeam')}}" class="form-horizontal" method="get" autocomplete="off" target="_blank" >
