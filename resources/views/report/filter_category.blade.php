...
@section('nav',action('ReportController@filterCategory'))
@section('content')
<ul class="breadcrumb no-border no-radius b-b b-light pull-in">
	<li><a href="{{action('BackendController@index')}}"></i>{{trans('app.home')}}</a></li>
	<li class="active">Report Contestant per Category</li>
</ul>
...
<section class="panel panel-default">
	<header class="panel-heading font-bold">Report Contestant per Category</header>
	<div class="panel-body">
		<form action="{{action('ReportController@printCategory')}}" class="form-horizontal" method="get" autocomplete="off" target="_blank" >
