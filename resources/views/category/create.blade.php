...
<ul class="breadcrumb no-border no-radius b-b b-light pull-in">
	...
	<li class="active">{{trans('app.category.create')}}</li>
</ul>

<div class="m-b-md">
	<h3 class="m-b-none">{{trans('app.category.create')}}</h3>
</div>

<section class="panel panel-default">
	<header class="panel-heading font-bold">{{trans('app.category.category')}}</header>
	<div class="panel-body">
		<form action="{{action('CategoryController@store')}}" method="post" class="form-horizontal" autocomplete="off">
			{!! csrf_field() !!}
			<div class="form-group {{$errors->has('name') ? 'has-error' : '' }}">
				<label class="col-sm-2 control-label font-bold">{{trans('app.category.name')}}</label>
				<div class="col-sm-10">
					<input type="text" name="name" class="form-control" value="{{old('name')}}" maxlength="20">
			...
			<div class="form-group {{$errors->has('rate_overall_impression') ? 'has-error' : '' }}">
				...
				<div class="col-sm-10">
					<div class="input-group m-b-none">
						<input type="text" name="rate_overall_impression" class="form-control" value="{{old('rate_overall_impression')}}" maxlength="5"> <span class="input-group-addon">%</span>
					</div>
			...
			<div class="form-group {{$errors->has('rate_head') ? 'has-error' : '' }}">
				...
				<div class="col-sm-10">
					<div class="input-group m-b-none">
						<input type="text" name="rate_head" class="form-control" value="{{old('rate_head')}}" maxlength="5"> <span class="input-group-addon">%</span>
					</div>
			...
			<div class="form-group {{$errors->has('rate_face') ? 'has-error' : '' }}">
				...
				<div class="col-sm-10">
					<div class="input-group m-b-none">
						<input type="text" name="rate_face" class="form-control" value="{{old('rate_face')}}" maxlength="5"> <span class="input-group-addon">%</span>
					</div>
			...
			<div class="form-group {{$errors->has('rate_body_shape') ? 'has-error' : '' }}">
				...
				<div class="col-sm-10">
					<div class="input-group m-b-none">
						<input type="text" name="rate_body_shape" class="form-control" value="{{old('rate_body_shape')}}" maxlength="5"> <span class="input-group-addon">%</span>
					</div>
			...
			<div class="form-group {{$errors->has('rate_marking') ? 'has-error' : '' }}">
				...
				<div class="col-sm-10">
					<div class="input-group m-b-none">
						<input type="text" name="rate_marking" class="form-control" value="{{old('rate_marking')}}" maxlength="5"> <span class="input-group-addon">%</span>
					</div>
			...
			<div class="form-group {{$errors->has('rate_pearl') ? 'has-error' : '' }}">
				...
				<div class="col-sm-10">
					<div class="input-group m-b-none">
						<input type="text" name="rate_pearl" class="form-control" value="{{old('rate_pearl')}}" maxlength="5"> <span class="input-group-addon">%</span>
					</div>
			...
			<div class="form-group {{$errors->has('rate_color') ? 'has-error' : '' }}">
				...
				<div class="col-sm-10">
					<div class="input-group m-b-none">
						<input type="text" name="rate_color" class="form-control" value="{{old('rate_color')}}" maxlength="5"> <span class="input-group-addon">%</span>
					</div>
			...
			<div class="form-group {{$errors->has('rate_finnage') ? 'has-error' : '' }}">
				...
				<div class="col-sm-10">
					<div class="input-group m-b-none">
						<input type="text" name="rate_finnage" class="form-control" value="{{old('rate_finnage')}}" maxlength="5"> <span class="input-group-addon">%</span>
					</div>
