...
//         $queryString = http_build_query(array_merge(Request::except('sort', 'order', 'page'), $parameters));
        $queryString = http_build_query(array_merge(Request::except('sort', 'order'), $parameters));
        ...
        $viewData = [
        		'class' => $anchorClass,
        		'url' => url(Request::path() . '?' . $queryString),
        		'title' => htmlentities($title),
        		'icon' => $icon
        ];
        
        return view('columnsortable.default',$viewData);
        /*
         * old code
         */
